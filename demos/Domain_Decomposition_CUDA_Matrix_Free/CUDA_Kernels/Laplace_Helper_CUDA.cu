...
__global__ void Laplace_Kernel_3D(const unsigned* masks, T* out,const T* in,
...
Laplace_Helper_CUDA<T,log2_struct,3,T_offset_ptr>::Laplace_Helper_CUDA(T* const x_input,const T* const y_input,
                                                                       ...
                                                                       const unsigned flag_to_check_input)
...
template <class T,int log2_struct,class T_offset_ptr> 
void Laplace_Helper_CUDA<T,log2_struct,3,T_offset_ptr>::Run_Index_Range(const unsigned int index_start,const unsigned int index_end,cudaStream_t& cuda_stream)
{
    ...
    Laplace_Kernel_3D<T,log2_struct,block_xsize,block_ysize,block_zsize,T_offset_ptr>
        <<<number_of_cuda_blocks,THREADBLOCK,0,cuda_stream>>> // Fix round-up division
        (mask,x,y,
         b+index_start,
