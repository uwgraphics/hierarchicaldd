...
//#####################################################################
#ifndef __Residual_Helper_CUDA__
#define __Residual_Helper_CUDA__
#include <algorithm>
#include <SPGrid/Core/SPGrid_Mask.h>

namespace SPGrid{
template<class T,int log2_struct, int d,class T_offset_ptr> class Residual_Helper_CUDA;
template<class T,int log2_struct,class T_offset_ptr>
class Residual_Helper_CUDA<T,log2_struct,3,T_offset_ptr>
{
    enum{d=3};
...
public:
    explicit Residual_Helper_CUDA(T* const r_input,const T* const u_input,const T* const rhs_input,const unsigned* const mask_input,
