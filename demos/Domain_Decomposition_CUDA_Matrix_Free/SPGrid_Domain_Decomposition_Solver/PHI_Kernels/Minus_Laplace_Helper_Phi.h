...
//#####################################################################
#ifndef __Minus_Laplace_Helper_Phi__
#define __Minus_Laplace_Helper_Phi__
#include <algorithm>
...
namespace SPGrid{
template<class T,int log2_struct, int d,class T_offset_ptr,bool accumulative=false> class Minus_Laplace_Helper_PHI;

#define SIMD_LENGTH 16
template<class T,int log2_struct,class T_offset_ptr,bool accumulative>
class Minus_Laplace_Helper_PHI<T,log2_struct,3,T_offset_ptr,accumulative>
{
    enum{d=3};
...
public:
    explicit Minus_Laplace_Helper_PHI(T* const Lu_input,const T* const u_input,const unsigned* const mask_input,const T_offset_ptr* const b_input,
