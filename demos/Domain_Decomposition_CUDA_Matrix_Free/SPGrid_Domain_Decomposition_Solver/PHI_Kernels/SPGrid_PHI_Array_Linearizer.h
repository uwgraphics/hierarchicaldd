...
namespace SPGrid{
    ...
    public:
        ...
        {}
        void Allocate(){
            if(posix_memalign((void**)&b        ,64,number_of_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_x_minus,64,number_of_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_x_plus ,64,number_of_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_y_minus,64,number_of_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_y_plus ,64,number_of_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_z_minus,64,number_of_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_z_plus ,64,number_of_blocks*sizeof(T_offset_ptr))) abort();

            if(posix_memalign((void**)&b_boundary        ,64,number_of_boundary_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_boundary_x_minus,64,number_of_boundary_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_boundary_x_plus ,64,number_of_boundary_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_boundary_y_minus,64,number_of_boundary_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_boundary_y_plus ,64,number_of_boundary_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_boundary_z_minus,64,number_of_boundary_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_boundary_z_plus ,64,number_of_boundary_blocks*sizeof(T_offset_ptr))) abort();

            if(posix_memalign((void**)&b_interface        ,64,number_of_interface_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_interface_x_minus,64,number_of_interface_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_interface_x_plus ,64,number_of_interface_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_interface_y_minus,64,number_of_interface_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_interface_y_plus ,64,number_of_interface_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_interface_z_minus,64,number_of_interface_blocks*sizeof(T_offset_ptr))) abort();
            if(posix_memalign((void**)&b_interface_z_plus ,64,number_of_interface_blocks*sizeof(T_offset_ptr))) abort();
