...
//Removed For Anonymity: Copyright Authors of Submission pap173s1
//#####################################################################
// Subroutine SPGrid_Computations::Copy_Interior
//#####################################################################
#ifndef __SPGrid_Copy_Interior_h__
#define __SPGrid_Copy_Interior_h__
...
public:
    Copy_Interior(T_FIELD T_STRUCT::* source_field_input,T_FIELD T_STRUCT::* destination_field_input)
...
public:
    Copy_Interior(T_DATA T_STRUCT::* source_field_input,T_DATA T_STRUCT::* destination_field_input,
        T_FLAGS T_STRUCT::* flags_field_input,const unsigned long mask_input)
        :source_field(source_field_input),destination_field(destination_field_input),
         flags_field(flags_field_input),mask(mask_input)
    {}
    
    Copy_Interior(SPGrid_Allocator<T_STRUCT,d>& allocator,const std::pair<const unsigned long*,unsigned>& blocks,
