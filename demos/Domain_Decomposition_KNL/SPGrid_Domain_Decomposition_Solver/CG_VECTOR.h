...
template<class T_STRUCT,class T,int d,typename T_offset_ptr=unsigned int> class CG_SYSTEM;
...
class CG_VECTOR:public KRYLOV_VECTOR_BASE<T>
{
 ...
 public:
    ...
    CG_VECTOR(SPG_Allocator& allocator_input,SPG_Set_Type& set_input,T T_STRUCT::* field_input,int number_of_threads_input=0)
        :allocator(allocator_input),set(set_input),field(field_input),number_of_threads(number_of_threads_input){}
