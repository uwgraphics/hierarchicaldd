...
public:
    ...
    SIGMA_MULTIGRID_SOLVER(INTERFACE_SOLVER_DATA<T,d>& solver_data_in,
                           std::vector<T_EIGEN_VECTOR,Eigen::aligned_allocator<std::pair<const int,T_EIGEN_VECTOR> > >& u_in,
                           std::vector<T_EIGEN_VECTOR,Eigen::aligned_allocator<std::pair<const int,T_EIGEN_VECTOR> > >& r_in,
                           std::vector<T_EIGEN_VECTOR,Eigen::aligned_allocator<std::pair<const int,T_EIGEN_VECTOR> > >& b_in,
