...
#define DIMENSION_READ_WRITE_HELPER(T,RW) \
    ...
    Read_Write<STRUCTURE<VECTOR<T,1> >,RW>::Register_Read_Write<ANALYTIC_IMPLICIT_OBJECT<POLYGON<VECTOR<T,1> > > >(); \
    ...
    Read_Write<STRUCTURE<VECTOR<T,2> >,RW>::Register_Read_Write<ANALYTIC_IMPLICIT_OBJECT<POLYGON<VECTOR<T,2> > > >(); \
    ...
    Read_Write<STRUCTURE<VECTOR<T,2> >,RW>::Register_Read_Write<ANALYTIC_IMPLICIT_OBJECT<CONICAL_FRUSTUM<VECTOR<T,2> > > >(); \
    ...
    Read_Write<STRUCTURE<VECTOR<T,3> >,RW>::Register_Read_Write<ANALYTIC_IMPLICIT_OBJECT<POLYGON<VECTOR<T,3> > > >(); \
    ...
    Read_Write<STRUCTURE<VECTOR<T,3> >,RW>::Register_Read_Write<ANALYTIC_IMPLICIT_OBJECT<CONICAL_FRUSTUM<VECTOR<T,3> > > >(); \
