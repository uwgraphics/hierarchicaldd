...
//#####################################################################
    ...
    void Fast_Marching_Method_Threaded_Part_Two(int tid,RANGE<TV_INT>& domain,T_ARRAYS_SCALAR& phi_ghost,ARRAY<T_ARRAYS_SCALAR>& phi_new_array,const T stopping_distance,const ARRAY<TV_INT>* seed_indices,const bool add_seed_indices_for_ghost_cells,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells);
    void Fast_Marching_Method(T_ARRAYS_SCALAR& phi_ghost,const T stopping_distance=0,const ARRAY<TV_INT>* seed_indices=0,const bool add_seed_indices_for_ghost_cells=false,const bool add_extra_fixed_seed_indices=false,const bool update_ghost_cells=false);
...
private:
    ...
    void Initialize_Interface(RANGE<TV_INT>& domain,T_ARRAYS_SCALAR& phi_ghost,T_ARRAYS_BOOL& done,T_ARRAYS_INT& close_k,ARRAY<TV_INT>& heap,int& heap_length,const ARRAY<TV_INT>* seed_indices,const bool add_seed_indices_for_ghost_cells=false,const bool add_extra_fixed_seed_indices=false);
