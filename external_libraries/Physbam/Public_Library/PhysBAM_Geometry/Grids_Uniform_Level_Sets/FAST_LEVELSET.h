...
public:
    void Fast_Marching_Method(const int local_advection_spatial_order,const T time=0,const ARRAY<TV_INT>* seed_indices=0,const bool add_extra_fixed_seed_indices=false,const bool update_ghost_cells=false);
