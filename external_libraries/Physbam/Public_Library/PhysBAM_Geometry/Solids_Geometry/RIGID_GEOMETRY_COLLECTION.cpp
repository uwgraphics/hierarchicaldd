...
RIGID_GEOMETRY_COLLECTION(RIGID_GEOMETRY_PARTICLES<TV>& particles_input,RIGID_GEOMETRY_EXAMPLE_VELOCITIES<TV>* rigid_geometry_example_velocities_input,
    ...
    frame_list_active(0),check_stale(false),last_read_key(-1),last_read_active(-1),allocate_helper(allocate_helper_input),rigid_geometry_example_velocities(rigid_geometry_example_velocities_input),owns_particles(false),owns_collision_body_list(collision_body_list==0)
{
...
RIGID_GEOMETRY_COLLECTION(RIGID_GEOMETRY_EXAMPLE_VELOCITIES<TV>* rigid_geometry_example_velocities_input,COLLISION_GEOMETRY_COLLECTION<TV>* collision_body_list_input,ALLOCATE_HELPER<TV>* allocate_helper_input)
    ...
    frame_list_key(0),frame_list_active(0),check_stale(false),last_read_key(-1),last_read_active(-1),allocate_helper(allocate_helper_input),rigid_geometry_example_velocities(rigid_geometry_example_velocities_input),owns_particles(true),owns_collision_body_list(collision_body_list==0)
{
    if(!allocate_helper) allocate_helper=new ALLOCATE_GEOMETRY_HELPER<TV>(*this);
    if(!collision_body_list) collision_body_list=new COLLISION_GEOMETRY_COLLECTION<TV>();
    particles.Store_Velocity();
