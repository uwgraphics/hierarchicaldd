...
public:
    ...
    RENDERING_TEXTURE_IMAGE_SHADER(RENDER_WORLD<T>& world_input,const bool wrap_s_input=true,const bool wrap_t_input=true,const bool cubic_interpolation_input=false,const T scaling_input=(T)1.0)
        :MATERIAL_SHADER<T>(world_input),wrap_s(wrap_s_input),wrap_t(wrap_t_input),scaling(scaling_input)
    {
