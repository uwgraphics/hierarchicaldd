...
public:
    ...
    {return shader.Shade_Surface_Using_Direct_Illumination(ray,exiting_object,entering_object,intersection_object,intersection_point,
                Rotate_Normal_Toward_Camera(ray.ray.aggregate_id,intersection_object,intersection_point,same_side_normal),tid);}
    ...
    {return shader.Shade_Light_Ray(ray,exiting_object,entering_object,intersection_object,intersection_point,
                Rotate_Normal_Toward_Camera(ray.ray.aggregate_id,intersection_object,intersection_point,same_side_normal),light,full_ray,tid);}
    ...
    {return shader.Receive_Photon(ray,exiting_object,entering_object,intersection_object,intersection_point,
            Rotate_Normal_Toward_Camera(ray.ray.aggregate_id,intersection_object,intersection_point,same_side_normal),power,type,diffuse_bounces,specular_bounces,tid);}
//#####################################################################
};
}
#endif
