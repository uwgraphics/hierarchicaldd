...
public:
    ...
    if((((int)floor(s*texture_scaling_factor)&0x1)==0)^(((int)floor(t*texture_scaling_factor)&0x1)==0))
        return shader1.Shade_Surface_Using_Direct_Illumination(ray,exiting_object,entering_object,intersection_object,intersection_point,same_side_normal,tid);
    else return shader2.Shade_Surface_Using_Direct_Illumination(ray,exiting_object,entering_object,intersection_object,intersection_point,same_side_normal,tid);}
