...
public:
    ...
    while(!last_segment){
        ...
        T current_volumetric_step=voxel_object->Volumetric_Integration_Step(RAY<VECTOR<T,3> >(current_position,-ray.ray.direction,true), world.random.Get_Uniform_Number((T)0,(T)1,tid));
