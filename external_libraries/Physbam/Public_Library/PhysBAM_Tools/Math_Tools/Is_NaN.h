...
template<class T>
inline bool Is_NaN(const VECTOR<T,4>& v)
{return Is_NaN(v(1))||Is_NaN(v(2))||Is_NaN(v(3))||Is_NaN(v(4));}

template<class T>
inline bool Is_NaN(const VECTOR<T,5>& v)
{return Is_NaN(v(1))||Is_NaN(v(2))||Is_NaN(v(3))||Is_NaN(v(4))||Is_NaN(v(5));}
