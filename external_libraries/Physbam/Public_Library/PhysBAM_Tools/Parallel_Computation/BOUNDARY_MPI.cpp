...
template class BOUNDARY_MPI<GRID<VECTOR<float,1> >,int>;
...
template class BOUNDARY_MPI<GRID<VECTOR<float,2> >,int>;
...
template class BOUNDARY_MPI<GRID<VECTOR<float,3> >,int>;
...
template class BOUNDARY_MPI<GRID<VECTOR<double,1> >,int>;
...
template class BOUNDARY_MPI<GRID<VECTOR<double,2> >,int>;
...
template class BOUNDARY_MPI<GRID<VECTOR<double,3> >,int>;
