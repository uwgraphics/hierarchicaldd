...
public:
    ...
    template<class T1,class T2,class T3,class T4,class T5,class T6> void Run(TYPE& my_class,void (TYPE::*func)(int,RANGE<TV_INT>&,T1,T2,T3,T4,T5,T6),T1 arg1,T2 arg2,T3 arg3,T4 arg4,T5 arg5,T6 arg6)
    {
        if(!thread_queue){(my_class.*func)(1,domains(1),arg1,arg2,arg3,arg4,arg5,arg6);return;}
#ifdef USE_PTHREADS
        for(int i=1;i<=domains.m;i++){
            ITERATOR_TASK_6<TYPE,RANGE<TV_INT>,T1,T2,T3,T4,T5,T6>* task=new ITERATOR_TASK_6<TYPE,RANGE<TV_INT>,T1,T2,T3,T4,T5,T6>(my_class,func,i,domains(i),arg1,arg2,arg3,arg4,arg5,arg6);
            thread_queue->Queue(task);}
        if(do_wait)thread_queue->Wait();
#else
        PHYSBAM_FATAL_ERROR();
    ...
    template<class T1,class T2,class T3,class T4,class T5,class T6,class T7> void Run(TYPE& my_class,void (TYPE::*func)(int,RANGE<TV_INT>&,T1,T2,T3,T4,T5,T6,T7),T1 arg1,T2 arg2,T3 arg3,T4 arg4,T5 arg5,T6 arg6,T7 arg7)
    {
        if(!thread_queue){(my_class.*func)(1,domains(1),arg1,arg2,arg3,arg4,arg5,arg6,arg7);return;}
#ifdef USE_PTHREADS
        for(int i=1;i<=domains.m;i++){
            ITERATOR_TASK_7<TYPE,RANGE<TV_INT>,T1,T2,T3,T4,T5,T6,T7>* task=new ITERATOR_TASK_7<TYPE,RANGE<TV_INT>,T1,T2,T3,T4,T5,T6,T7>(my_class,func,i,domains(i),arg1,arg2,arg3,arg4,arg5,arg6,arg7);
            thread_queue->Queue(task);}
        if(do_wait)thread_queue->Wait();
#else
        PHYSBAM_FATAL_ERROR();
    ...
    {
        if(!thread_queue){(my_class.*func)(domains(1),arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10);return;}
#ifdef USE_PTHREADS
        for(int i=1;i<=domains.m;i++){
