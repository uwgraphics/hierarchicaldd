...
template<> struct DATATYPE_HELPER<char>{static MPI::Datatype Datatype(){return MPI::CHAR;}};
...
template<class T> struct DATATYPE_HELPER<PAIR<VECTOR<int,2>,VECTOR<T,1> > >{static MPI::Datatype Datatype();};
template<class T> struct DATATYPE_HELPER<PAIR<VECTOR<int,2>,VECTOR<T,2> > >{static MPI::Datatype Datatype();};
template<class T> struct DATATYPE_HELPER<PAIR<VECTOR<int,2>,VECTOR<T,3> > >{static MPI::Datatype Datatype();};
template<class T> struct DATATYPE_HELPER<PAIR<VECTOR<T,2>,int> >{static MPI::Datatype Datatype();};
template<class T> struct DATATYPE_HELPER<PAIR<VECTOR<T,2>,float> >{static MPI::Datatype Datatype();};
template<class T> struct DATATYPE_HELPER<PAIR<VECTOR<T,2>,double> >{static MPI::Datatype Datatype();};
...
template<class TV_INT> struct DATATYPE_HELPER<VECTOR<PAIR<int,TV_INT>,3> >{static MPI::Datatype Datatype();};
template<class TV_INT> struct DATATYPE_HELPER<VECTOR<PAIR<int,TV_INT>,4> >{static MPI::Datatype Datatype();};
template<class T,class TV_INT> struct DATATYPE_HELPER<PAIR<PAIR<int,TV_INT>,T> >{static MPI::Datatype Datatype();};
...
template<class T> inline void Reduce(const VECTOR_ND<T>& input,VECTOR_ND<T>& output,const MPI::Op& op,const MPI::Intracomm& comm)
{MPI::Datatype type=MPI_UTILITIES::Datatype<T>();assert(type==MPI::INT || type==MPI::FLOAT || type==MPI::DOUBLE);assert(input.n==output.n);
comm.Allreduce(input.Get_Array_Pointer(),output.Get_Array_Pointer(),output.n,type,op);}
//#####################################################################
