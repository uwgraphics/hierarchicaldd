...
#define INSTANTIATION_HELPER_MPI(T,T_GRID,d)                            \
    ...
    template MPI_PACKAGE MPI_UNIFORM_GRID<T_GRID >::Package_Face_Data(T_FACE_ARRAYS::REBIND<int>::TYPE& data,const ARRAY<RANGE<T_GRID::VECTOR_INT> >& region) const; \
    ...
    template MPI_PACKAGE MPI_UNIFORM_GRID<T_GRID >::Package_Common_Face_Data(T_FACE_ARRAYS::REBIND<int>::TYPE& data,const int,const RANGE<T_GRID::VECTOR_INT>& region) const; \
