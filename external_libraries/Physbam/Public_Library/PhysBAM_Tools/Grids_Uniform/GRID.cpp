...
template GRID<VECTOR<float,3> > GRID<VECTOR<float,3> >::Create_Even_Sized_Grid_Given_Cell_Size(RANGE<VECTOR<float,3> > const&,float,bool,int);
...
template GRID<VECTOR<double,3> > GRID<VECTOR<double,3> >::Create_Even_Sized_Grid_Given_Cell_Size(RANGE<VECTOR<double,3> > const&,double,bool,int);
#endif
