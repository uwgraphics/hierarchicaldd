...
public:
    ...
    DIAGONAL_MATRIX Min(const T a) const
    {return DIAGONAL_MATRIX(min(x11,a),min(x22,a),min(x33,a));}

    DIAGONAL_MATRIX Max(const T a) const
    {return DIAGONAL_MATRIX(max(x11,a),max(x22,a),max(x33,a));}
