...
public:
    ...
    MATRIX_MXN<T> Times_Cross_Product_Matrix_Transpose(const VECTOR<T,1>& v) const
    {PHYSBAM_NOT_IMPLEMENTED();}

    MATRIX_MXN<T> Cross_Product_Matrix_Times(const VECTOR<T,1>& v) const
    {PHYSBAM_NOT_IMPLEMENTED();}
