//#####################################################################
// Copyright 2006-2013, Geoffrey Irving, Craig Schroeder, Rahul Sheth, Tamar Shinar.
...
template<class T,class T_MATRIX> class MATRIX_VIEW;
template<class T,class T_MATRIX,class T_VECTOR> class GENERAL_MATRIX;

template<class T_MATRIX,class T_VECTOR> class LAZY_MATRIX_VECTOR_PRODUCT;

template<class T_MATRIX> struct IS_MATRIX {static const bool value=false;};
template<class T,class T_MATRIX> struct IS_MATRIX<MATRIX_BASE<T,T_MATRIX> > {static const bool value=true;};
template<class T> struct IS_MATRIX<SYMMETRIC_MATRIX_NXN<T> > {static const bool value=true;};
...
template<class T_MATRIX> struct IS_MATRIX<TRANSPOSE_MATRIX<T_MATRIX> > {static const bool value=true;};
