...
//#####################################################################
// Class READ_WRITE_VORONOI_DIAGRAM
//#####################################################################
#ifndef COMPILE_WITHOUT_READ_WRITE_SUPPORT
#ifndef __READ_WRITE_VORONOI_DIAGRAM__
#define __READ_WRITE_VORONOI_DIAGRAM__
...
class Read_Write<VORONOI_DIAGRAM<TV>,RW>
{
  public:
    static void Read(std::istream& input,VORONOI_DIAGRAM<TV>& object)
    {
        object.Clean_Memory();
        // read center
        Read_Binary<RW>(input,object.volume);
    ...
    static void Write(std::ostream& output,const VORONOI_DIAGRAM<TV>& object)
    {
        // write center
        Write_Binary<RW>(output,object.volume);
