...
template class Laplace_Helper<double,5,2>;
template class Laplace_Helper<double,6,2>;

template class Laplace_Helper<double,5,3>;
template class Laplace_Helper<double,6,3>;
#endif
