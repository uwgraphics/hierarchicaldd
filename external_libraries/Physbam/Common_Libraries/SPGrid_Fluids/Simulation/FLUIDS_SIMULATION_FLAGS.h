...
enum {
    ...
    SPGrid_Node_T_Junction     = 0x00001000u,
    SPGrid_Node_Ghost          = 0x00004000u,

    // Determined by cell types

    SPGrid_Face_Minus_X_Active = SPGrid_Face_Type_X_Active, // aliased
    SPGrid_Face_Minus_Y_Active = SPGrid_Face_Type_Y_Active, // aliased
    SPGrid_Face_Minus_Z_Active = SPGrid_Face_Type_Z_Active, // aliased
...
enum{MG_Boundary=SPGrid_Node_Coarse_Shared}; // Careful!
}
