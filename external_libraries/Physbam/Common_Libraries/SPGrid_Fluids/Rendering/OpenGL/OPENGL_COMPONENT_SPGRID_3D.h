...
//#####################################################################
// Class OPENGL_COMPONENT_SPGRID_3D
//##################################################################### 
#ifndef __OPENGL_COMPONENT_SPGRID_3D__
#define __OPENGL_COMPONENT_SPGRID_3D__
...
class OPENGL_COMPONENT_SPGRID_3D : public OPENGL_COMPONENT
{
    typedef FLUIDS_SIMULATION_DATA<T> T_STRUCT;typedef VECTOR<T,3> TV;
public:
    GRID<TV>& fine_grid;
...
public:
    ...
    virtual void Set_Slice(OPENGL_SLICE *slice_input) PHYSBAM_OVERRIDE {slice=slice_input;opengl_spgrid.Set_Slice(slice_input);}
