...
//#####################################################################
// Class OPENGL_SPGRID_SCALAR_FIELD_3D
//##################################################################### 
#ifndef __OPENGL_SPGRID_SCALAR_FIELD_3D__
#define __OPENGL_SPGRID_SCALAR_FIELD_3D__
...
class OPENGL_SPGRID_SCALAR_FIELD_3D : public OPENGL_OBJECT
{
public:
...
public:
    OPENGL_SPGRID_SCALAR_FIELD_3D(GRID<TV> &fine_mac_grid_input,OPENGL_SPGRID_3D<T>& opengl_spgrid_input,OPENGL_COLOR_MAP<T2>* color_map_input,bool& draw_separate_levels_input,int& level_counter_input,T T_STRUCT::* field_input,DRAW_MODE draw_mode_input=DRAW_TEXTURE);
