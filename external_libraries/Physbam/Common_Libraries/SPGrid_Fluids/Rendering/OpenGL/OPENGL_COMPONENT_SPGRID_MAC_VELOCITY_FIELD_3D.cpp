...
//#####################################################################
template<class T,class RW> OPENGL_COMPONENT_SPGRID_MAC_VELOCITY_FIELD_3D<T,RW>::
OPENGL_COMPONENT_SPGRID_MAC_VELOCITY_FIELD_3D(GRID<TV> &fine_mac_grid,OPENGL_SPGRID_3D<T>& opengl_spgrid,std::string& filename1_input,std::string& filename2_input,std::string& filename3_input,T T_STRUCT::* field1_input,T T_STRUCT::* field2_input,T T_STRUCT::* field3_input,bool& draw_separate_levels,int& level_counter)
    : OPENGL_COMPONENT("SPGrid MAC Velocity Field 3D"),opengl_mac_velocity_field(fine_mac_grid,opengl_spgrid,field1_input,field2_input,field3_input,draw_separate_levels,level_counter),channel_filename1(filename1_input),channel_filename2(filename2_input),channel_filename3(filename3_input),field1(field1_input),field2(field2_input),field3(field3_input)
{
...
//#####################################################################
template<class T,class RW> bool OPENGL_COMPONENT_SPGRID_MAC_VELOCITY_FIELD_3D<T,RW>::
...
//#####################################################################
template<class T,class RW> void OPENGL_COMPONENT_SPGRID_MAC_VELOCITY_FIELD_3D<T,RW>::
...
// Function Set_Frame
//#####################################################################
template<class T,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_SPGRID_MAC_VELOCITY_FIELD_3D<T,RW>::
Bounding_Box() const
{
...
Reinitialize()
{
    if(draw){
        if((is_animation && frame_loaded!=frame) || (!is_animation && frame_loaded<0)){
            ...
            channel_filenames.Append(channel_filename3);
            ...
            GRID_HIERARCHY_PROJECTION<T_STRUCT,T,3>::Compute_Divergence(*(opengl_mac_velocity_field.opengl_spgrid.hierarchy),&T_STRUCT::flags,fields(1),fields(2),fields(3),opengl_mac_velocity_field.divergence_channel);

            frame_loaded=frame;valid=true;}}
}
//#####################################################################
template class OPENGL_COMPONENT_SPGRID_MAC_VELOCITY_FIELD_3D<float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_SPGRID_MAC_VELOCITY_FIELD_3D<double,double>;
#endif
