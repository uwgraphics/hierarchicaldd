...
// Constructor
//#####################################################################
template<class T,class T2,class RW> OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<T,T2,RW>::
OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D(GRID<TV> &fine_mac_grid,OPENGL_SPGRID_3D<T>& opengl_spgrid,const std::string &channel_filename_input,T T_STRUCT::* field_input,OPENGL_COLOR_MAP<T2>* color_map_input,bool& draw_separate_levels,int& level_counter)
    : OPENGL_COMPONENT("SPGrid Scalar Field 3D"),opengl_scalar_field(fine_mac_grid,opengl_spgrid,color_map_input,draw_separate_levels,level_counter,field_input),
...
//#####################################################################
template<class T,class T2,class RW> bool OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<T,T2,RW>::
...
// Function Set_Frame
//#####################################################################
template<class T,class T2,class RW> void OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<T,T2,RW>::
...
//#####################################################################
template<class T,class T2,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<T,T2,RW>::
Bounding_Box() const
{
...
//#####################################################################
template class OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<float,int,float>;
template class OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<float,bool,float>;
template class OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<float,float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<double,int,double>;
template class OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<double,bool,double>;
template class OPENGL_COMPONENT_SPGRID_SCALAR_FIELD_3D<double,double,double>;
#endif
