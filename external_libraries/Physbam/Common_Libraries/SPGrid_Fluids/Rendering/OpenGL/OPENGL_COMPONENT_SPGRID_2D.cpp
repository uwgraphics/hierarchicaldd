...
#include <SPGrid_Fluids/Rendering/OpenGL/OPENGL_COMPONENT_SPGRID_2D.h>
using namespace PhysBAM;
//#####################################################################
// Constructor
//#####################################################################
template<class T,class RW> OPENGL_COMPONENT_SPGRID_2D<T,RW>::
OPENGL_COMPONENT_SPGRID_2D(GRID<TV> &fine_grid_input,const std::string& filename_input,bool& draw_separate_levels,int& level_counter,bool& draw_nodal_flags,int& nodal_flag_counter,const int frame_input)
    :OPENGL_COMPONENT("SPGrid 2D"),fine_grid(fine_grid_input),opengl_spgrid(fine_grid,draw_separate_levels,level_counter,draw_nodal_flags,nodal_flag_counter,filename_input,OPENGL_COLOR::Gray(.5),frame_input),filename(filename_input),frame_loaded(-1),valid(false)
{
...
//#####################################################################
template<class T,class RW> bool OPENGL_COMPONENT_SPGRID_2D<T,RW>::
...
// Function Set_Frame
//#####################################################################
template<class T,class RW> void OPENGL_COMPONENT_SPGRID_2D<T,RW>::
...
//#####################################################################
template<class T,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_SPGRID_2D<T,RW>::
Bounding_Box() const
{
...
//#####################################################################
template class OPENGL_COMPONENT_SPGRID_2D<float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_SPGRID_2D<double,double>;
#endif
