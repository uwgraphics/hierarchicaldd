...
enum {
    ...
    SPGrid_Solver_Cell_Type_Interface = 0x00080000u, // Generated by dd, If a cell is interface, then the Active flag will be removed.
    ...
    SPGrid_Solver_PartitionID_Mask    = 0x0000ffffu, // The ID start from 1. ID of zero means exterior, dirichlet, or interface cells 
    
    SPGrid_Solver_Cell_Type_Interface_Boundary = 0x10000000u
};
}
