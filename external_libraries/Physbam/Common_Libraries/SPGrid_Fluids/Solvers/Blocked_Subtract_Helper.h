...
//#####################################################################
#ifndef __Blocked_Subtract_Helper__
#define __Blocked_Subtract_Helper__
namespace SPGrid{

template<class T,int elements_per_block>
class Blocked_Subtract_Helper
{
...
public:
    explicit Blocked_Subtract_Helper(T* const x_input,const T* const y_input, const unsigned* const flags_input, const unsigned long* const b_input, const int size_input)
