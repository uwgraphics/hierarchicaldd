...
// Constructor
//#####################################################################
template<class T_STRUCT, class T> TRAILING_NGN_ITERATOR<T_STRUCT,T,2>::
...
//#####################################################################
template<class T_STRUCT, class T> void TRAILING_NGN_ITERATOR<T_STRUCT,T,2>::
Enumerate_Neighbors()
{
    // Add my own cell
...
//#####################################################################
template class TRAILING_NGN_ITERATOR<FLUIDS_SIMULATION_DATA<float>,float,2>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class TRAILING_NGN_ITERATOR<FLUIDS_SIMULATION_DATA<double>,double,2>;
#endif
