...
//#####################################################################
// Class OPENGL_COMPONENT_OCTREE_SCALAR_FIELD
//##################################################################### 
#ifndef __OPENGL_COMPONENT_OCTREE_SCALAR_FIELD__
#define __OPENGL_COMPONENT_OCTREE_SCALAR_FIELD__
...
class OPENGL_COMPONENT_OCTREE_SCALAR_FIELD: public OPENGL_COMPONENT
{
...
public:
    ...
    ~OPENGL_COMPONENT_OCTREE_SCALAR_FIELD() {}
    ...
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_OCTREE_SCALAR_FIELD, Toggle_Color_Map, "Toggle color map");

private:
    void Reinitialize();

public:
    OPENGL_OCTREE_SCALAR_FIELD<T,T2> opengl_scalar_field;
