...
#include <Visualization/Components/OPENGL_COMPONENT_VORONOI_DIAGRAM_2D.h>
using namespace PhysBAM;
//#####################################################################
// Constructor
//#####################################################################
template<class T,class RW> OPENGL_COMPONENT_VORONOI_DIAGRAM_2D<T,RW>::
OPENGL_COMPONENT_VORONOI_DIAGRAM_2D(const std::string& filename_input,const int frame_input)
    :OPENGL_COMPONENT("Voronoi 2D"),filename(filename_input),frame_loaded(-1),valid(false)
{
...
// Valid_Frame
//#####################################################################
template<class T,class RW> bool OPENGL_COMPONENT_VORONOI_DIAGRAM_2D<T,RW>::
...
// Set_Frame
//#####################################################################
template<class T,class RW> void OPENGL_COMPONENT_VORONOI_DIAGRAM_2D<T,RW>::
...
// Bounding_Box
//#####################################################################
template<class T,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_VORONOI_DIAGRAM_2D<T,RW>::
Bounding_Box() const
{
...
//#####################################################################
template class OPENGL_COMPONENT_VORONOI_DIAGRAM_2D<float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_VORONOI_DIAGRAM_2D<double,double>;
#endif
